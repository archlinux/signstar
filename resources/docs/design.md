...
- Service host
    ...
    - As the Server has Operator credentials to signing keys, if it is fully compromised, it can issue any signatures, including ones that will not be added to the Transparency log.
- Client
    ...
    - Clients don't have direct access to signing keys nor can directly influence the structure of signatures.
- Digital Signatures
