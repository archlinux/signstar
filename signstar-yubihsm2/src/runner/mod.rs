...
/// Serializes the `object` to JSON and writes a newline after that.
///
/// # Errors
///
/// Returns an error if
...
impl ScenarioRunner {
    /// Create a new scenario runner for given connector and scenario.
    ///
    /// # Errors
    ///
    /// Returns an error if
    ...
    /// Executes given commands using current client.
    ///
    /// # Errors
    ///
    /// Returns an error if
