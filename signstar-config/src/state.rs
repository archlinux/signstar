...
pub trait StateHandling {
    ...
    fn is_comparable(&self, other: &impl StateHandling) -> bool {
        self.state_type().is_comparable(other.state_type())
    }
