...
impl<'a, 'b> NetHsmBackend<'a, 'b> {
    ...
    /// - system-wide keys,
    /// - users in the system-wide, non-administrative roles (i.e. [`Backup`][`UserRole::Backup`],
    ///   [`Metrics`][`UserRole::Metrics`] and [`Operator`][`UserRole::Operator`]),
    ...
    ///   namespaces,
    /// - namespaced keys,
    /// - users in the namespaced, non-administrative roles (i.e.
