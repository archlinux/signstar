...
mod tests {
    ...
    #[rstest]
    #[case::only_system_wide_admin(ConfigBuilder::new(SystemConfig::new(
            1,
            AdministrativeSecretHandling::Plaintext,
            NonAdministrativeSecretHandling::Plaintext,
            BTreeSet::new(),
        ...
        .finish()?)]
    #[case::system_wide_and_namespace_admins(ConfigBuilder::new(SystemConfig::new(
            1,
            AdministrativeSecretHandling::Plaintext,
            NonAdministrativeSecretHandling::Plaintext,
            BTreeSet::new(),
        ...
        .finish()?)]
    fn nethsm_admin_credentials_try_from_config_succeeds(#[case] config: Config) -> TestResult {
