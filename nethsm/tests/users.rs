...
use nethsm::test::DEFAULT_OPERATOR_USER_REAL_NAME;
use nethsm::test::NAMESPACE1;
use nethsm::test::NAMESPACE1_ADMIN_REAL_NAME;
use nethsm::test::NAMESPACE1_ADMIN_USER_ID;
use nethsm::test::NAMESPACE1_ADMIN_USER_PASSPHRASE;
use nethsm::test::NAMESPACE1_OPERATOR_REAL_NAME;
use nethsm::test::NAMESPACE1_OPERATOR_USER_ID;
use nethsm::test::NAMESPACE1_OPERATOR_USER_PASSPHRASE;
use nethsm::test::NAMESPACE2;
use nethsm::test::NAMESPACE2_ADMIN_REAL_NAME;
use nethsm::test::NAMESPACE2_ADMIN_USER_ID;
use nethsm::test::NAMESPACE2_ADMIN_USER_PASSPHRASE;
use nethsm::test::NAMESPACE2_OPERATOR_REAL_NAME;
use nethsm::test::NAMESPACE2_OPERATOR_USER_ID;
use nethsm::test::NAMESPACE2_OPERATOR_USER_PASSPHRASE;
use nethsm::test::NetHsmImage;
use nethsm::test::OTHER_OPERATOR_USER_ID;
use nethsm::test::OTHER_OPERATOR_USER_PASSPHRASE;
use nethsm::test::OTHER_OPERATOR_USER_REAL_NAME;
use nethsm::test::provisioned_nethsm;
