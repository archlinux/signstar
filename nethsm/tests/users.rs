...
use common::NAMESPACE1_ADMIN_REAL_NAME;
use common::NAMESPACE1_ADMIN_USER_ID;
use common::NAMESPACE1_ADMIN_USER_PASSPHRASE;
use common::NAMESPACE1_OPERATOR_REAL_NAME;
use common::NAMESPACE1_OPERATOR_USER_ID;
use common::NAMESPACE1_OPERATOR_USER_PASSPHRASE;
use common::NAMESPACE2;
use common::NAMESPACE2_ADMIN_REAL_NAME;
use common::NAMESPACE2_ADMIN_USER_ID;
use common::NAMESPACE2_ADMIN_USER_PASSPHRASE;
use common::NAMESPACE2_OPERATOR_REAL_NAME;
use common::NAMESPACE2_OPERATOR_USER_ID;
use common::NAMESPACE2_OPERATOR_USER_PASSPHRASE;
