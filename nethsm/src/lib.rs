...
impl NetHsm {
    ...
    pub fn new(
        ...
        let (current_credentials, credentials) = if let Some(credentials) = credentials {
            ...
            info!("Create new NetHSM connection {connection} with no initial credentials");
    ...
    pub fn add_credentials(&self, credentials: Credentials) {
        info!("Add NetHSM connection credentials for {credentials}");
    ...
    pub fn remove_credentials(&self, user_id: &UserId) {
        info!("Remove NetHSM connection credentials for {user_id}");
    ...
    pub fn use_credentials(&self, user_id: &UserId) -> Result<(), Error> {
        info!("Use NetHSM connection credentials of {user_id}");
    ...
    pub fn provision(
        ...
        info!("Provision the NetHSM at {}", self.url.borrow());
    ...
    pub fn alive(&self) -> Result<(), Error> {
        info!("Check whether the NetHSM at {} is alive", self.url.borrow());
    ...
    pub fn ready(&self) -> Result<(), Error> {
        info!("Check whether the NetHSM at {} is ready", self.url.borrow());
    ...
    pub fn state(&self) -> Result<SystemState, Error> {
        info!("Get the state of the NetHSM at {}", self.url.borrow());
    ...
    pub fn info(&self) -> Result<InfoData, Error> {
        info!("Get info about the NetHSM at {}", self.url.borrow());
