...
const GET_CREDENTIALS_PAYLOAD: &str = "signstar-sign";
...
async fn load_credentials_for_user(#[case] config_data: &[u8]) -> TestResult {
    ...
    tokio::spawn(async move {
        ...
        builder
            .set_private_key_file("tests/fixtures/key.not-pem", SslFiletype::PEM)
            .unwrap();
        builder
            .set_certificate_chain_file("tests/fixtures/cert.not-pem")
            .unwrap();
