...
//!
//! ```
//! use signstar_core::system_user::{get_home_base_dir_path, get_relative_user_secrets_dir};
//!
...
pub const USER_SECRETS_DIR: &str = ".local/state/signstar/secrets/";

/// The file extension of plaintext credential files.
pub const PLAINTEXT_SECRETS_EXTENSION: &str = "txt";

/// The file extension of systemd-creds encrypted credential files.
pub const SYSTEMD_CREDS_SECRETS_EXTENSION: &str = "creds";
