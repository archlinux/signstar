...
impl From<sha2::Sha512> for SignatureInput {
...
impl TryFrom<SignatureInput> for sha2::Sha512 {
    type Error = Error;
    fn try_from(value: SignatureInput) -> Result<Self, Self::Error> {
...
/// Required parameters for the signing operation.
#[derive(Debug, Serialize, Deserialize)]
pub struct Required {
