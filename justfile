...
containerized-integration-tests-all:
    ...
    just --set clean_coverage_workspace false containerized-integration-tests --locked --no-default-features --package signstar-configure --features _yubihsm2-mockhsm,yubihsm2
    just --set clean_coverage_workspace false containerized-integration-tests --locked --no-default-features --package signstar-configure --features nethsm
    just --set clean_coverage_workspace false containerized-integration-tests --locked --no-default-features --package signstar-configure --features _yubihsm2-mockhsm,nethsm,yubihsm2
